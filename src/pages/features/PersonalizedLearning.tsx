  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white">
      ...
      <main className="max-w-7xl mx-auto py-12 px-4">
        <h1 className="text-4xl font-extrabold text-primary mb-6 drop-shadow-lg">Personalized Learning</h1>
        
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-indigo-900 mb-4">Learning Tailored to Each Child</h2>
          <p className="text-gray-700 mb-4">
            Every child learns differently. Our adaptive learning system adjusts to each learner's unique needs, preferences, and pace. Using advanced algorithms and data analysis, we create a customized learning path that evolves as your child grows.
          </p>

          <h3 className="text-xl font-bold text-indigo-800 mt-8 mb-3">How Personalized Learning Works:</h3>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>Initial skill assessment to determine current knowledge level</li>
            <li>Smart algorithms that adapt to learning style and pace</li>
            <li>Dynamic difficulty adjustment based on performance</li>
            <li>Personalized recommendations for lessons and activities</li>
            <li>Regular reassessment to ensure optimal challenge level</li>
            <li>Learning path that evolves with each interaction</li>
          </ul>

          <div className="mt-12 p-6 bg-indigo-50 rounded-lg">
            <h3 className="text-xl font-bold text-indigo-900 mb-3">The Benefits of Personalization:</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="font-bold text-indigo-800">Increased Engagement</h4>
                <p className="text-sm text-gray-600">Content that matches a child's interests keeps them motivated and engaged</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="font-bold text-indigo-800">Optimal Challenge Level</h4>
                <p className="text-sm text-gray-600">Not too easy, not too hard - the perfect level of challenge for growth</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="font-bold text-indigo-800">Builds Confidence</h4>
                <p className="text-sm text-gray-600">Success at the right pace builds mathematical confidence</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="font-bold text-indigo-800">Addresses Gaps</h4>
                <p className="text-sm text-gray-600">Identifies and fills knowledge gaps in foundational concepts</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="font-bold text-indigo-800">Accelerated Learning</h4>
                <p className="text-sm text-gray-600">Allows advanced students to move ahead at their own pace</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="font-bold text-indigo-800">Learning Preferences</h4>
                <p className="text-sm text-gray-600">Adapts to visual, auditory, and kinesthetic learning styles</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-12">
          <h2 className="text-2xl font-bold text-indigo-900 mb-4">Experience Learning That's Tailored Just for Your Child</h2>
